...
PILOT_ID_NONE = None  # indicator value for no pilot configured
HEAT_ID_NONE = None  # indicator value for practice heat
CLASS_ID_NONE = None  # indicator value for unclassified heat
FORMAT_ID_NONE = None  # indicator value for unformatted class
